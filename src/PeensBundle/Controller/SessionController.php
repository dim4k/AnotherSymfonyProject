...
use PeensBundle\Entity\Session;
use PeensBundle\Form\SessionType;
...
class SessionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $sessions = $em->getRepository('PeensBundle:Session')->findAll();
    ...
    {
        $session = new Session();
        $form = $this->createForm('PeensBundle\Form\SessionType', $session);
    ...
    {
        $deleteForm = $this->createDeleteForm($session);
        $editForm = $this->createForm('PeensBundle\Form\SessionType', $session);
