...
use PeensBundle\Entity\Note;
use PeensBundle\Form\NoteType;
...
class NoteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $notes = $em->getRepository('PeensBundle:Note')->findAll();
    ...
    {
        $note = new Note();
        $form = $this->createForm('PeensBundle\Form\NoteType', $note);
    ...
    {
        $deleteForm = $this->createDeleteForm($note);
        $editForm = $this->createForm('PeensBundle\Form\NoteType', $note);
